    ...
    >
        <div className='space-y-4'>
            <div className='space-y-2'>
                <label htmlFor="voucher" className=''>
                    Do you have a voucher or gift card?
                </label>
                <input 
                    type="text"
                    id='voucher'
                    className='block w-full focus:outline-none bg-gray-700 rounded-lg border border-gray-600 p-2.5 text-sm text-white placeholder-gray-400 focus:border-emerald-500 focus:ring-emerald-500'
